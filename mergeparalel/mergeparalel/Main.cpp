...
int main(int argc, char** argv) {
    ...
    vector<string> input_files = {
        "data_100000000.txt", "data_75000000.txt", "data_50000000.txt",
        "data_25000000.txt", "data_10000000.txt"
    };
    ...
    if (selected_file.find("100000000") != string::npos) total_elements = 100000000;
    else if (selected_file.find("75000000") != string::npos) total_elements = 75000000;
    else if (selected_file.find("50000000") != string::npos) total_elements = 50000000;
    else if (selected_file.find("25000000") != string::npos) total_elements = 25000000;
    else if (selected_file.find("10000000") != string::npos) total_elements = 10000000;
    else {
